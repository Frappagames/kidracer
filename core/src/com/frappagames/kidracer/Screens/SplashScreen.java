...
public class SplashScreen implements Screen {
    ...
    public SplashScreen(KidRacer gameApp) {
        this.game = gameApp;
        ...
        camera.setToOrtho(false, KidRacer.WIDTH, KidRacer.HEIGHT);

        Image splashImage = new Image(splashTexture);
        stage.addActor(splashImage);
        splashImage.setX((KidRacer.WIDTH / 2) - (splashImage.getWidth() / 2));
        splashImage.setY((KidRacer.HEIGHT / 2) - (splashImage.getHeight() / 2));
